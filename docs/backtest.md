...
> ⚠ **DÜZELTME (2026-09-23, karar 56): bu paragraf YANLIŞTI ve iki yerden.**
...
| 4 | `xsec_mom`: kesitsel momentum (21g geriye bakış, top-3, haftalık rebalance) long-only bir edge taşır | §6g, bu commit | A: 2022-01-01 → 2024-06-30, B: A+embargo → koşu günü | P2: A'da `xsec_mom` ort. R > `xsec_random` ort. R | ⚠ **KOŞULDU ama ÖN-KAYITTAKİ PENCERE ÖLÇÜLMEDİ** (`backtest-xsec` #35578057311, 2026-09-21; karar 56): soğuk önbellek + `--history-bars 3000` ile dönem A 2022-01-01'e hiç ulaşmadı, **2023-02-16 → 2024-06-29** koştu (5465 barın 3000'i; `missing_bars` 2465 — harness B-2'yi uygulamadığı için koşu yeşil döndü); dönem B de aynı mekanizmayla 2025-05-09'dan başladı (yeniden üretimle doğrulandı). Koşunun kendi verdikti ("BLOKE — K-3") ve sayıları bu satırın SONUCU DEĞİLDİR. **Sonuç: DEĞERLENDİRİLEMEDİ** — doğru pencerede koşu kullanıcının kararıdır |
...
> ⚠ **DÜZELTME (2026-09-23, karar 56) — pencere taştı; bu bölümün SAYILARI değişmez.**
...
### ⚠ KOŞU KAYDI — koşuldu, ama ön-kayıttaki pencere ÖLÇÜLMEDİ *(2026-09-23, karar 56)*
...
> ⚠ **SAPMA — dönem A'nın penceresi taştı (karar 56).** Geri yüklenen önbellek 2026-09'a
