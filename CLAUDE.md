...
| **Yönün işareti** | `vwap_clone` (13) ↔ `vwap_inverse` (22) | yalnızca yön (aynı kurulum, aynalanmış seviyeler, aynı R:R) | AÇIK — ön-kayıt `docs/backtest.md > 6g`, koşu bekliyor |
