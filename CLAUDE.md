...
| Sürenin katkısı (ADAY) | `scalp_fixed` (12) ↔ `scalp_patient` (16) | zaman stop'u sınırı (16 ↔ 100 bar) |
| Volatilite rejiminin katkısı (ADAY) | `scalp_patient` (16) ↔ `scalp_vol` (17) | kesitsel ATR% medyan kapısı |
