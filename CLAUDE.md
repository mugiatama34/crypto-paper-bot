...
| **Birimin katkısı** | `vwap_clone` (13) ↔ `vwap_session` (19, F0) | VWAP çapası + σ tahmincisi (başka hiçbir şey) | AÇIK — ön-kayıt `docs/backtest.md > 6f`, koşu bekliyor |
